...
;(function () {
	...
	Slider.prototype = {
		...
		init: function() {
			...
			var loop = setInterval(this.loopPic, this.duration + this.frameDuration, this);
		},
		...
		loopPic: function(that) {
			...
			var action = setTimeout(function() {
				AnimationBaseTime(that.imgs[nextIndex], 'opacity', 60, 1, this.duration);
				AnimationBaseTime(that.imgs[that.currentIndex], 'opacity', 60, 0, this.duration);
			}, that.frameDuration);
